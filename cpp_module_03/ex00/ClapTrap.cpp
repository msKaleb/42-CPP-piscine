...
/*   Updated: 2023/11/14 12:08:35 by msoria-j         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack(const std::string &target) {
	...
	if (this->_hitPoints == 0 && this->_energyPoints == 0)
		std::cout << BOLDYELLOW<< "ClapTrap " << this->getName() 
...
void	ClapTrap::takeDamage(unsigned int amount) {
	if (this->_hitPoints > 0) {
		...
		// print message
		std::cout << RED << "ClapTrap " << this->getName() << " receives " << amount
			<< " points of damage " << std::endl << RESET;
		return ;
	}
	std::cout << BOLDRED << "ClapTrap " << this->getName() 
...
void	ClapTrap::beRepaired(unsigned int amount) {
	if (this->_energyPoints > 0 && this->_hitPoints > 0) {
		...
		std::cout << GREEN << "ClapTrap " << this->getName() << " gets "
	...
	if (this->_energyPoints == 0)
		...
		std::cout << BOLDGREEN << "ClapTrap " << this->getName() 
